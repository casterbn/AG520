...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon '
              '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong '
              '-pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat '
              '-Wformat-security -Werror=format-security '
              ' '
              '-shared -Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed '
              '-Wl,-z,relro,-z,now,-z,noexecstack -Wl,-O1 -Wl,--hash-style=gnu '
              '-Wl,--as-needed -Wl,-z,relro,-z,now,-z,noexecstack',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon '
       '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong -pie '
       '-fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat -Wformat-security '
       '-Werror=format-security '
       '',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g  -O3 -Wall '
           '-Wstrict-prototypes -O2 -fomit-frame-pointer    -Wa,--noexecstack '
           '-fexpensive-optimizations   -frename-registers -ftree-vectorize   '
           '-finline-functions -finline-limit=64   '
           '-Wno-error=maybe-uninitialized -Wno-error=unused-result  -O2 '
           '-fomit-frame-pointer    -Wa,--noexecstack '
           '-fexpensive-optimizations   -frename-registers -ftree-vectorize   '
           '-finline-functions -finline-limit=64   '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-O2 -fomit-frame-pointer    -Wa,--noexecstack '
 ...
 'CONFIG_ARGS': "'--build=x86_64-linux' '--host=arm-oe-linux-gnueabi' "
                ...
                "'CC=arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb "
                '-mfpu=neon -mfloat-abi=hard -DNDEBUG -fno-inline '
                '-fstack-protector-strong -pie -fPIE -D_FORTIFY_SOURCE=2 '
                '-Wa,--noexecstack -Wformat -Wformat-security '
                '-Werror=format-security '
                "' "
                "'CFLAGS= -O2 -fomit-frame-pointer    -Wa,--noexecstack "
                '-fexpensive-optimizations   -frename-registers '
                '-ftree-vectorize   -finline-functions -finline-limit=64   '
                "-Wno-error=maybe-uninitialized -Wno-error=unused-result    ' "
                "'LDFLAGS=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed "
                "-Wl,-z,relro,-z,now,-z,noexecstack' 'CPPFLAGS=' "
                "'CPP=arm-oe-linux-gnueabi-gcc -E "
                '  '
                '-march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard -DNDEBUG '
                '-fno-inline -fstack-protector-strong -pie -fPIE '
 ...
 'COVERAGE_INFO': '/python3/3.5.6-r1.0/build/coverage.info',
 'COVERAGE_REPORT': '/python3/3.5.6-r1.0/build/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Python-3.5.6/Include',
 'CXX': 'arm-oe-linux-gnueabi-g++  -march=armv7-a -mthumb -mfpu=neon '
        '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong -pie '
        '-fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat '
        '-Wformat-security -Werror=format-security '
        '',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'arm-oe-linux-gnueabi-g++  -march=armv7-a -mthumb -mfpu=neon '
                '-mfloat-abi=hard -DNDEBUG -fno-inline '
                '-fstack-protector-strong -pie -fPIE -D_FORTIFY_SOURCE=2 '
                '-Wa,--noexecstack -Wformat -Wformat-security '
                '-Werror=format-security '
                ' '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon '
             '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong '
             '-pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat '
             '-Wformat-security -Werror=format-security '
             ' '
 ...
 'LINKCC': 'arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon '
           '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong '
           '-pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat '
           '-Wformat-security -Werror=format-security '
           '',
 ...
 'MAINCC': 'arm-oe-linux-gnueabi-gcc  -march=armv7-a -mthumb -mfpu=neon '
           '-mfloat-abi=hard -DNDEBUG -fno-inline -fstack-protector-strong '
           '-pie -fPIE -D_FORTIFY_SOURCE=2 -Wa,--noexecstack -Wformat '
           '-Wformat-security -Werror=format-security '
           '',
 ...
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/python3/3.5.6-r1.0/build '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=/usr/lib/python3.5/lib-dynload/:/python3/3.5.6-r1.0/build/build/lib.linux-arm-3.5:/python3/3.5.6-r1.0/Python-3.5.6/Lib:/python3/3.5.6-r1.0/Python-3.5.6/Lib/plat-linux '
                     'python3.5',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g  -O3 -Wall '
              ...
              '-finline-limit=64   -Wno-error=maybe-uninitialized '
              '-Wno-error=unused-result  -O2 -fomit-frame-pointer    '
              '-Wa,--noexecstack -fexpensive-optimizations   '
              '-frename-registers -ftree-vectorize   -finline-functions '
              '-finline-limit=64   -Wno-error=maybe-uninitialized '
              '-Wno-error=unused-result',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement -O2 '
                     '-fomit-frame-pointer    -Wa,--noexecstack '
                     '-fexpensive-optimizations   -frename-registers '
                     '-ftree-vectorize   -finline-functions '
                     '-finline-limit=64   -Wno-error=maybe-uninitialized '
                     '-Wno-error=unused-result      -fprofile-use '
                     '-fprofile-correction',
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g  -O3 -Wall '
                   ...
                   '-finline-limit=64   -Wno-error=maybe-uninitialized '
                   '-Wno-error=unused-result '
                   '-Werror=declaration-after-statement -O2 '
                   '-fomit-frame-pointer    -Wa,--noexecstack '
                   '-fexpensive-optimizations   -frename-registers '
                   '-ftree-vectorize   -finline-functions -finline-limit=64   '
                   ...
                   '-I../Python-3.5.6/Include -fPIC -DPy_BUILD_CORE',
 ...
 'PY_LDFLAGS': '-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed '
               '-Wl,-z,relro,-z,now,-z,noexecstack -Wl,-O1 '
 ...
 'abs_builddir': '/python3/3.5.6-r1.0/build',
 'abs_srcdir': '/python3/3.5.6-r1.0/build/../Python-3.5.6',
