...
#define CWLOG(...)     __android_log_print(ANDROID_LOG_DEBUG, "ql_can", ##__VA_ARGS__)
#define CWERR(...)     __android_log_print(ANDROID_LOG_ERROR, "ql_can", ##__VA_ARGS__)
