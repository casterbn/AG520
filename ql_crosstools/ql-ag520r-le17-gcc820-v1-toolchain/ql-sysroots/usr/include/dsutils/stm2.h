...
/*===========================================================================
  ...
  Copyright (c) 2007-2008, 2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
*/
#define STM_INVALID_INDEX           ((int32_t)-1)
...
typedef struct
{
  ...
  const uint32_t  uid;              /*!< Unique ID for this state machine
                                         instance.  Lower 32-bits of standard
                                         MD5 message digest of name string. */

  const uint32_t  this_instance;    /*!< This particular state machine instance */
...
typedef struct stm_state_machine_s
{
  ...
  int32_t     curr_input_index; /*!< Index of the current or most-recent
  ...
  uint32_t    debug_mask;       /*!< User defined debug mask */
...
extern uint32_t stm_get_num_instances
(
  const stm_state_machine_t *sm
);
...
extern uint32_t stm_get_instance_num
(
  const stm_state_machine_t *sm
);
...
extern uint32_t stm_get_num_states
(
  const stm_state_machine_t *sm
);
...
extern uint32_t stm_get_debug_mask
(
  const stm_state_machine_t *sm
);
