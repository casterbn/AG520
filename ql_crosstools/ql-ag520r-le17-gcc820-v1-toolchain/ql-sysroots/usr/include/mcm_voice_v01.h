...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed May  6 2020 (Spin 0)
...
typedef enum {
  ...
  MCM_VOICE_DTMF_EVENT_REV_BURST_V01 = 0, /**<  Sends a CDMA-burst DTMF. */
  MCM_VOICE_DTMF_EVENT_REV_START_CONT_V01 = 1, /**<  Starts a continuous DTMF tone. */
  MCM_VOICE_DTMF_EVENT_REV_STOP_CONT_V01 = 2, /**<  Stops a continuous DTMF tone. */
  MCM_VOICE_DTMF_EVENT_FWD_BURST_V01 = 3, /**<  Received a CDMA-burst DTMF message. */
  MCM_VOICE_DTMF_EVENT_FWD_START_CONT_V01 = 4, /**<  Received a start-continuous DTMF tone order. */
  MCM_VOICE_DTMF_EVENT_FWD_STOP_CONT_V01 = 5, /**<  Received a stop-continuous DTMF tone order. */
  MCM_VOICE_DTMF_EVENT_IP_INCOMING_DTMF_START_V01 = 6, /**<  Received an IP-start continuous DTMF message. */
  MCM_VOICE_DTMF_EVENT_IP_INCOMING_DTMF_STOP_V01 = 7, /**<  Received an IP-stop continuous DTMF message. */
...
typedef enum {
  ...
  MCM_ECALL_VARIANT_ENUM_MIN_ENUM_VAL_V02_V01 = -2147483647, /**<  To force a 32 bit signed enum.  Do not change or use */
  MCM_ECALL_TEST_V02_V01 = 0x01, /**<  Test eCall */
  MCM_ECALL_EMERGENCY_V02_V01 = 0x02, /**<  Emergency eCall */
  MCM_ECALL_RECONFIG_V02_V01 = 0x03, /**<  Reconfig eCall */
  MCM_ECALL_VARIANT_ENUM_MAX_ENUM_VAL_V02_V01 = 2147483647, /**<  To force a 32 bit signed enum.  Do not change or use */
...
typedef struct {
 ...
 0 -- Disable; 1 -- Enable*/
  ...
  /**<   The ecall system standard.*/

  /* 	0 -- EU; 1 -- ERA_GLONASS */
  uint16_t era_glonass_redial_time;
  /**<   The timer of era_glonass redial times.*/

  uint16_t era_glonass_auto_answer_time;
  /**<   The timer of era_glonass auto answer times.*/
...
typedef enum {
  ...
  MCM_VOICE_ECALL_EVENT_FAIL_CLEAR_DOWN_FALLBACK_TIMEOUT_V01 = 5, /**<  clear down fallback timeout.	 */
  MCM_VOICE_ECALL_EVENT_FAIL_IVS_INITIATION_TIMEOUT_V01 = 6, /**<  IVS initiation timeout. */
...
/** @addtogroup mcm_voice_qmi_enums
  ...
  */
typedef enum {
  MCM_VOICE_ECALL_EVENT_EXTEND_STATE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_VOICE_ECALL_EVENT_ECALL_START_RECEIVED_SYNCHRONIZATION_V01 = 0, /**<  eCall start recevied synchronization. */
  MCM_VOICE_ECALL_EVENT_T9_TIMEOUT_V01 = 1, /**<  eCall T9 TIMEOUT. */
  MCM_VOICE_ECALL_EVENT_T10_TIMEOUT_V01 = 2, /**<  eCall T10 TIMEOUT. */
  MCM_VOICE_ECALL_EVENT_IVS_ALACK_RECEIVED_V01 = 3, /**<  IVS receives ALACK message. */
  MCM_VOICE_ECALL_EVENT_IVS_LLACK_RECEIVED_V01 = 4, /**<  IVS receives LLACK message. */
  MCM_VOICE_ECALL_EVENT_STOPPED_V01 = 5, /**<  IVS receives STOPPED message. */
  MCM_VOICE_ECALL_EVENT_ANSWERING_INCOMING_PSAP_ECALL_V01 = 6, /**<  IVS AUTO ANSWERING INCOMING PSAP ECALL. */
  MCM_VOICE_ECALL_EVENT_CLEARDOWN_RECEIVED_V01 = 7, /**<  IVS receives CLEARDOWN message. */
  MCM_VOICE_ECALL_EVENT_EXTEND_STATE_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_voice_ecall_event_extend_state_t_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /* 	0 -- EU; 1 -- ERA_GLONASS */
  uint8_t era_glonass_redial_time_valid;  /**< Must be set to true if era_glonass_redial_time is being passed */
  uint16_t era_glonass_redial_time;
  /**<   The timer of era_glonass redial times.*/

  /* Optional */
  uint8_t era_glonass_auto_answer_time_valid;  /**< Must be set to true if era_glonass_auto_answer_time is being passed */
  uint16_t era_glonass_auto_answer_time;
  /**<   The timer of era_glonass auto answer times.*/
...
typedef struct {
  ...
  mcm_voice_ecall_event_extend_state_t_v01 ecall_event_extend_state;
  /**<   event of eCall extend state.*/
