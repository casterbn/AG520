...
private:
    ...
    void closeFile();
    void socketConnect();
    void ntripClientApiConnect();
    void injectDataToCdfw(uint8_t* buffer, uint32_t bufferSize);
    void concateAndInject(uint8_t* buffer, uint32_t recvBytes);
