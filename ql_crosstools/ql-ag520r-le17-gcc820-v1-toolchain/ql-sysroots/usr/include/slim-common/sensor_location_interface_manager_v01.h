...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  2014-2017 Qualcomm Atheros, Inc.
   All rights reserved.
  Qualcomm Atheros Proprietary and Confidential.

  $Header: //components/rel/qmimsgs.mpss/5.0/slim/api/sensor_location_interface_manager_v01.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SLIM_V01_IDL_MINOR_VERS 0x04
...
typedef enum {
  ...
  eQMI_SLIM_SERVICE_VEHICLE_STEERING_WHEEL_V01 = 20, /**<  Vehicle steering wheel service  */
 ...
 */
 ...
 Values: \n
      ...
      - eQMI_SLIM_SERVICE_VEHICLE_STEERING_WHEEL (20) --  Vehicle steering wheel service
 */
...
typedef struct {
  ...
  /**<   Batch Start Time, in milli second  w.r.to the first Valid Sensor Sample from the kernel. */
...
/** @addtogroup slim_qmi_messages
    @{
  */
/** RequestRequest Message; Enables reporting for a specified sensor. */
typedef struct {
...
/** @addtogroup slim_qmi_messages
    @{
  */
/** Request Message; Enables vehicle sensor, speed, differential wheel speed, gear, steering wheel or odometry data. */
typedef struct {
...
typedef struct {
  ...
  /* Optional */
  /*  Sample Time Offsets */
  uint8_t sampleTimeOffsetsSubMilliNs_valid;  /**< Must be set to true if sampleTimeOffsetsSubMilliNs is being passed */
  uint32_t sampleTimeOffsetsSubMilliNs_len;  /**< Must be set to # of elements in sampleTimeOffsetsSubMilliNs */
  uint32_t sampleTimeOffsetsSubMilliNs[QMI_SLIM_SENSOR_MAX_SAMPLE_SETS_V01];
  /**<
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  On-vehicle steering wheel Samples */
  uint8_t steering_wheel_valid;  /**< Must be set to true if steering_wheel is being passed */
  uint32_t steering_wheel_len;  /**< Must be set to # of elements in steering_wheel */
  float steering_wheel[QMI_SLIM_VEHICLE_MOTION_DATA_MAX_SAMPLE_SETS_V01];
  /**<
    Optional variable length array to specify the on-vehicle steering wheel samples.
    Steering Wheel samples in degrees.
  */
