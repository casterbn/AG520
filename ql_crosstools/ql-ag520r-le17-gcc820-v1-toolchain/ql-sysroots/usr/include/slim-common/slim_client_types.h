...
Copyright (c) 2013-2017, 2019-2020 Qualcomm Technologies, Inc.
All Rights Reserved.
...
============================================================================*/
/* $Header: //components/rel/gnss8.mpss/10.1/gnss/slim/common/client/inc/slim_client_types.h#1 $ */
...
/**
@brief TILT service data message.

@sa slimTiltDataStructT
*/
typedef struct {
  slimServiceProviderEnumT provider;
  /**< Provider of this data. One of: \n
...
typedef enum
{
  ...
  /**< DEPRECATED : Unstable device motion detected */
  eSLIM_PED_ALIGNMENT_EVENT_FAKE_PEDALIGN           = 5,
  /**< Dummy Pedestrian alignment during SAMLite failure */
  eSLIM_PED_ALIGNMENT_EVENT_RESET                   = 6,
  /**< Ped alignment outputs are volatile due to attKF reset (usually a data gap) */
  eSLIM_PED_ALIGN_AXIS_SWITCH                       = 7,
  /* Report an axis switch since it indicates definite inconsistency with previous RTA */
  eSLIM_PED_ALIGN_ATTKF_BOOST_PROC_NOISE            = 8,
  /* AttKF boosts process noise to handle mag cal figure 8's etc */
  eSLIM_PED_ALIGN_ATTKF_HIGH_DYNAMICS               = 9,
  /* AttKF is attempting to track undersampled dynamics with gyro bias under high dynamics */
  eSLIM_PED_ALIGN_ATTKF_MAGFREE_RTA                 = 10,
  /* AttKF is producing a mag-free attkf that gets mag updates under limited circumstances */
  eSLIM_PED_ALIGN_ANCHOR_NOT_ESTABLISHED            = 11,
  /* RTA now only establishes and clears the anchor with three consistent strides */
  eSLIM_PED_ALIGN_RTA_UNRELIABLE                    = 12,
  /* If the current stride mean gravity is inconsistent with the anchor we may have */
  /* an alignment change or transient motion so mark the RTA as unreliable */
...
typedef enum
{
  ...
  eSLIM_VEHICLE_MOTION_SENSOR_TYPE_STEERING_WHEEL = 3, /**< Steering wheel data */
...
typedef struct
{
  ...
  /**< Type: Floating point \n
       ...
       - Units: degrees */
} slimVehicleMotionSteeringWheelDataSampleStructT;
...
typedef union
{
  ...
  /**<   Sensor Type: eSLIM_VEHICLE_MOTION_SENSOR_TYPE_GEAR
       ...
       - Units: - */
  slimVehicleMotionSteeringWheelDataSampleStructT steering_wheel;
...
typedef enum
{
  ...
  eSLIM_SERVICE_TILT   = 21,
  /**< Tilt Event service */

  eSLIM_SERVICE_VEHICLE_STEERING_WHEEL   = 22,
  /**< Vehicle steering wheel data service */

  eSLIM_SERVICE_LAST = eSLIM_SERVICE_VEHICLE_STEERING_WHEEL,
...
typedef enum
{
  ...
  eSLIM_MESSAGE_ID_DISTANCE_BOUND_DATA_GET_IND,
  /**< slimDistanceBoundDataStructT */

  /* Tilt messages */
  eSLIM_MESSAGE_ID_TILT_IND,
  /**< slimTiltDataStructT */
  eSLIM_MESSAGE_ID_TILT_ENABLE_RESP,
  /**< no payload */
  eSLIM_MESSAGE_ID_TILT_DISABLE_RESP,
  /**< no payload */

  /* Service status indication */
  eSLIM_MESSAGE_ID_GET_SERVICE_STATUS_RESP,
  /**< no payload */
...
/** SLIM DISTANCE_BOUND motion-state enums */
typedef enum {
    SLIM_DB_MS_UNKNOWN = 0,
    SLIM_DB_MS_STATIONARY = 1,
    SLIM_DB_MS_MOVE = 2,
    SLIM_DB_MS_FIDDLE = 3,
    SLIM_DB_MS_PEDESTRIAN = 4,
    SLIM_DB_MS_VEHICLE = 5,
    SLIM_DB_MS_WALK = 6,
    SLIM_DB_MS_RUN = 7,
    SLIM_DB_MS_BIKE = 8,
    SLIM_DB_MS_COUNT = 9
} slimDistanceBoundMotionStateEnumType;
...
typedef struct
{
  ...
  float motionStateSpeedBounds[SLIM_DB_MS_COUNT];
  /**<
    ...
    use default values. The slimDistanceBoundMotionStateEnumType specifies the index of
...
/*! @brief Struct for Tilt data reporting configuration parameters */
typedef struct {

  slimEnableServiceDataStructT enableConf;
  /**< Configuration for service enabling/disabling. */

} slimEnableTiltRequestStructT;
