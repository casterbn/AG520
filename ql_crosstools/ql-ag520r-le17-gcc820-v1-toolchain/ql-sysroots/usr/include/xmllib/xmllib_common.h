...
/*===========================================================================
  ...
  Copyright (c) 2005, 2019 by Qualcomm Technologies, Inc.
  All Rights Reserved.
...
SIDE EFFECTS
  None
===========================================================================*/
typedef int32_t (*xmllib_peekbytes_fptr_type)
(
  struct xmllib_metainfo_s_type *metainfo,  /* XML meta information struct */
  int32_t                        offset,    /* Offset in the text          */
  int32_t                        bytecount, /* Number of bytes to return   */
  uint8_t                        *buffer     /* Buffer to return byte in    */
);
...
===========================================================================*/
typedef int32_t (*xmllib_getbytes_fptr_type)
(
  struct xmllib_metainfo_s_type *metainfo,  /* XML meta information struct */
  int32_t                        bytecount, /* Number of bytes to consume  */
...
SIDE EFFECTS
  None
===========================================================================*/
typedef int32_t (*xmllib_putbytes_fptr_type)
(
  struct xmllib_gen_metainfo_s_type *metainfo,    /* XML meta info struct  */
  uint32_t                           numbytes,    /* num of bytes to put   */
  char                              *buffer,      /* contains bytes to put */
  uint32_t                          *bytesput     /* actual bytes put      */
);
