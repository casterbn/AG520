...
(
  ...
  uint32_t                *token_bytes,     /* Number of bytes in token    */
...
(
  ...
  uint32_t                   *bytesgen,     /* bytes generated             */
