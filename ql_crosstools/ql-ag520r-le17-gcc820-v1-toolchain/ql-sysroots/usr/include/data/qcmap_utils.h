...
#define QCMAP_NL_RNDIS_INTERFACE            "rndis0"
  ...
  #define QCMAP_NL_ECM_INTERFACE            "usb0"
#else
...
#define QCMAP_NL_WLAN4_INTERFACE            "wlan4"
#define QCMAP_NL_BT_INTERFACE               "bt-pan"
...
bool qcmap_nl_get_phyifaceName_vlan_id_from_iface(char *iface_name,\
                                                  char *phy_iface_name,\
                                                  int16_t *vlan_id);
