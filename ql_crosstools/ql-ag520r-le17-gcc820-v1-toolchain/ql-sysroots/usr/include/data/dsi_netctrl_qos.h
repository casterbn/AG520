...
typedef struct
{
  ...
  dsi_qos_status_event_type     status_evt;  /**< Flow status. See dsi_qos_status_event_type. */
  dsi_qmi_qos_reason_code_type  reason_code; /**< Reason code if the flow is disconnected. */
} ds_qos_info_t; /** Event information associated with a QoS status indication.
