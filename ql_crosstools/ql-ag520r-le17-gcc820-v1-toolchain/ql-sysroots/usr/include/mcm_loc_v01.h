...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Mar 13 2019 (Spin 0)
...
#define MCM_LOC_V01_MAX_MESSAGE_ID 0x031B
/**
    @}
  */
...
/**  Maximum number of satellites in view. */
#define MCM_LOC_GNSS_MAX_SVS_CONST_V01 64
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_enums
  ...
  */
typedef enum {
  MCM_GNSS_CONSTELLATION_TYPE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_LOC_GNSS_CONSTELLATION_UNKNOWN_V01 = 0, 
  MCM_LOC_GNSS_CONSTELLATION_GPS_V01 = 1, 
  MCM_LOC_GNSS_CONSTELLATION_SBAS_V01 = 2, 
  MCM_LOC_GNSS_CONSTELLATION_GLONASS_V01 = 3, 
  MCM_LOC_GNSS_CONSTELLATION_QZSS_V01 = 4, 
  MCM_LOC_GNSS_CONSTELLATION_BEIDOU_V01 = 5, 
  MCM_LOC_GNSS_CONSTELLATION_GALILEO_V01 = 6, 
  MCM_GNSS_CONSTELLATION_TYPE_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_gnss_constellation_type_t_v01;
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_enums
  ...
  */
typedef enum {
  MCM_GNSS_SV_FLAGS_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_LOC_GNSS_SV_FLAGS_NONE_V01 = 0, 
  MCM_LOC_GNSS_SV_FLAGS_HAS_EPHEMERIS_DATA_V01 = 0x00000001, 
  MCM_LOC_GNSS_SV_FLAGS_HAS_ALMANAC_DATA_V01 = 0x00000002, 
  MCM_LOC_GNSS_SV_FLAGS_USED_IN_FIX_V01 = 0x00000004, 
  MCM_GNSS_SV_FLAGS_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_gnss_sv_flags_t_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t register_gnss_sv_info_ind;
  /**<   Register for GNSS SV information indications.*/
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t provider_val;
  /**<   GNSS NMEA provider mode, 1=Modem Processor, 0=AP Processor */
}mcm_loc_set_provider_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  mcm_response_t_v01 resp;
  /**<   Result code.*/
}mcm_loc_set_provider_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}mcm_loc_get_provider_req_msg_v01;
...
typedef struct {
  ...
  uint8_t provider_val;
  /**<   GNSS NMEA provider mode, 1=Modem Processor, 0=AP Processor */
}mcm_loc_get_provider_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_messages
    @{
  */
/** Request Message; Enable Auto Inject UTC Time And XTRA Data. */
typedef struct {

  /* Mandatory */
  /*  Enable flag */
  uint8_t auto_inject_xtra;
  /**<   Auto Inject XTRA .*/
}mcm_loc_auto_inject_xtra_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_messages
    @{
  */
/** Response Message; Enable Auto Inject UTC Time And XTRA Data. */
typedef struct {
  ...
  mcm_response_t_v01 resp;
  /**<   Result code.*/
}mcm_loc_auto_inject_xtra_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  mcm_gnss_constellation_type_t_v01 constellation;
  ...
  uint32_t flags;
  /**<   Contains additional data about the given SV. Value should be one of those MCM_LOC_GNSS_SV_FLAGS_* constants */
}mcm_gnss_sv_info_t_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_messages
    @{
  */
/**  Message; Indication with the satellites in view payload. */
typedef struct {
  ...
  /* Mandatory */
  mcm_gnss_sv_info_t_v01 sv_list[MCM_LOC_GNSS_MAX_SVS_CONST_V01];
}mcm_loc_gnss_sv_info_ind_msg_v01;  /* Message */
/**
    @}
  */
...
#define MCM_LOC_SET_PROVIDER_REQ_V01 0x030E
#define MCM_LOC_SET_PROVIDER_RESP_V01 0x030E
#define MCM_LOC_GET_PROVIDER_REQ_V01 0x030F
#define MCM_LOC_GET_PROVIDER_RESP_V01 0x030F
#define MCM_LOC_AUTO_INJECT_XTRA_REQ_V01 0x0310
#define MCM_LOC_AUTO_INJECT_XTRA_RESP_V01 0x0310
#define MCM_LOC_LOCATION_INFO_IND_V01 0x0311
#define MCM_LOC_STATUS_INFO_IND_V01 0x0312
#define MCM_LOC_SV_INFO_IND_V01 0x0313
#define MCM_LOC_NMEA_INFO_IND_V01 0x0314
#define MCM_LOC_CAPABILITIES_INFO_IND_V01 0x0315
#define MCM_LOC_UTC_TIME_REQ_IND_V01 0x0316
#define MCM_LOC_XTRA_DATA_REQ_IND_V01 0x0317
#define MCM_LOC_AGPS_STATUS_IND_V01 0x0318
#define MCM_LOC_NI_NOTIFICATION_IND_V01 0x0319
#define MCM_LOC_XTRA_REPORT_SERVER_IND_V01 0x031A
#define MCM_LOC_GNSS_SV_INFO_IND_V01 0x031B
/**
    @}
  */
