...
*/
/*===========================================================================
  Copyright (c) 2011, 2013, 2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
/* Conversions of types handled by the configdb parser.
   ...
   e.g. boolean, int16_t, uint8_t etc */
...
typedef int32_t (*configdb_type_converter_t)
(
  const char *str_data,         /* source string data */
  void  *data,                  /* storage for converted data */
  uint32_t size                 /* size of memory allocated for data */
);
...
/*===========================================================================
  ...
  */
/*=========================================================================*/
int32_t configdb_get_parameter(
   const char *param_id,
...
/*===========================================================================
  ...
  */
/*=========================================================================*/
int32_t configdb_register_type_converter(
   const char *type,
