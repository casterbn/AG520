...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Thu Aug  1 2019 (Spin 0)
   From IDL File: mcm_common_v01.idl */

/** @defgroup mcm_common_qmi_consts Constant values defined in the IDL */
/** @defgroup mcm_common_qmi_msg_ids Constant values for QMI message IDs */
/** @defgroup mcm_common_qmi_enums Enumerated types used in QMI messages */
/** @defgroup mcm_common_qmi_messages Structures sent as QMI messages */
/** @defgroup mcm_common_qmi_aggregates Aggregate types used in QMI messages */
/** @defgroup mcm_common_qmi_accessor Accessor for QMI service object */
/** @defgroup mcm_common_qmi_version Constant values for versioning information */
...
/** @addtogroup mcm_common_qmi_version
    @{
  */
/** Major Version Number of the IDL used to generate this file */
#define MCM_COMMON_V01_IDL_MAJOR_VERS 0x01
/** Revision Number of the IDL used to generate this file */
#define MCM_COMMON_V01_IDL_MINOR_VERS 0x01
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define MCM_COMMON_V01_IDL_TOOL_VERS 0x06

/**
    @}
  */

/** @addtogroup mcm_common_qmi_enums
    @{
  */
typedef enum {
  MCM_CMD_STATE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_CMD_STATE_NONE_V01 = 0x0000, /**<  No command state. */
...
typedef enum {
  ...
  MCM_TECH_NONE_V01 = 0x0000, /**<  No network technology selected.  */
...
typedef enum {
  ...
  MCM_DOMAIN_NONE_V01 = 0x0000, /**<  No network call domain selected.  */
...
typedef enum {
  ...
  MCM_ERROR_SMS_NAS_CRT_UNKNOWN_V01 = 114, /**<  SMS ERROR BEASUSE OF NAS UNKNOWN. */
  MCM_ERROR_SIM_PIN_BLOCKED_V01 = 115, /**<  SIM PIN is blocked. */
  MCM_ERROR_SIM_PIN_NOT_INITIALIZED_V01 = 116, /**<  SIM PIN is not initialized. */
  MCM_ERROR_SIM_INVALID_PIN_V01 = 117, /**<  SIM PIN is invalid. */
  MCM_ERROR_SIM_INVALID_PERSO_CK_V01 = 118, /**<  SIM invalid personalization CK. */
  MCM_ERROR_SIM_PERSO_BLOCKED_V01 = 119, /**<  SIM personalization blocked. */
  MCM_ERROR_SIM_PERSO_INVALID_DATA_V01 = 120, /**<  SIM personalization contains invalid data. */
  MCM_ERROR_SIM_ACCESS_DENIED_V01 = 121, /**<  SIM access is denied. */
  MCM_ERROR_SIM_INVALID_FILE_PATH_V01 = 122, /**<  SIM file path is invalid. */
  MCM_ERROR_SIM_SERVICE_NOT_SUPPORTED_V01 = 123, /**<  SIM service is not supported. */
  MCM_ERROR_SIM_AUTH_FAIL_V01 = 124, /**<  SIM authorization failure. */
  MCM_ERROR_SIM_PIN_PERM_BLOCKED_V01 = 125, /**<  SIM PIN is permanently blocked. */
  MCM_ERROR_NV_NO_FILE_V01 = 126, /**<  NV file not exist. */
  MCM_ERROR_NV_FS_NOT_SUPPORTED_V01 = 127, /**<  NV file system not supported. */
  MCM_ERROR_NV_BAD_SIZE_V01 = 128, /**<  NV bad buffer size. */
  MCM_ERROR_NV_BAD_BUF_V01 = 129, /**<  NV buffer is NULL. */
...
/** @addtogroup mcm_common_qmi_aggregates
    @{
  */
typedef struct {
