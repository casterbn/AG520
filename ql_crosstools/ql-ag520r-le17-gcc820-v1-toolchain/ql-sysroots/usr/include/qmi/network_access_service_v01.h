...
/* This file was generated with Tool version 6.14.9
   It was generated on: Wed Mar  4 2020 (Spin 0)
...
#define NAS_V01_IDL_MINOR_VERS 0x11A
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00F5
/**
    @}
  */
...
/** @addtogroup nas_qmi_enums
  ...
  */
typedef enum {
  NR5G_RRC_STATE_EXT_E_TYPE_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  NR5G_RRC_STATE_IDLE_CAMPED_V01 = 0, /**<  Idle Camped \n */
  NR5G_RRC_STATE_CONNECTED_V01 = 1, /**<  Connected \n  */
  NR5G_RRC_STATE_INACTIVE_CAMPED_V01 = 2, /**<  Inactive Camped  */
  NR5G_RRC_STATE_EXT_E_TYPE_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}nr5g_rrc_state_ext_e_type_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Reg High Capability Subscription Indication */
  uint8_t reg_high_capability_sub_ind_valid;  /**< Must be set to true if reg_high_capability_sub_ind is being passed */
  uint8_t reg_high_capability_sub_ind;
  /**<   Controls the reporting of QMI_NAS_HIGH_CAPABILITY_SUB_IND_MSG. Values: \n
       - 0x00 -- Disable (default) \n
       - 0x01 -- Enable
  */

  /* Optional */
  /*  Reg Jamming_status Indication */
  uint8_t reg_jamming_status_ind_valid;  /**< Must be set to true if reg_jamming_status_ind is being passed */
  uint8_t reg_jamming_status_ind;
  /**<   Controls the reporting of QMI_NAS_JAMMING_STATUS_IND_MSG. Values: \n
      - 0x00 -- Disable (default value) \n
      - 0x01 -- Enable
  */
...
typedef struct {
  ...
  */
  ...
  int16_t rsrp;
  /**<   Current RSRP in units of 0.1 dBm as measured by L1.
  */

  int16_t snr;
  /**<   Current SNR in units of 0.1 dB as measured by L1.
  */
}nas_nr5g_serving_cell_info_type_v01;  /* Type */
/**
    @}
  */
 ...
 */
  ...
  */
  ...
  uint8_t nr5g_serving_cell_info_valid;  /**< Must be set to true if nr5g_serving_cell_info is being passed */
  nas_nr5g_serving_cell_info_type_v01 nr5g_serving_cell_info;
  /**<   NR5G serving cell info.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Configures high capability subscription. */
typedef struct {

  /* Mandatory */
  /*  High Capability Sub */
  nas_subs_type_enum_v01 high_capability_sub;
}nas_set_high_capability_sub_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Configures high capability subscription. */
typedef struct {

  /* Mandatory */
  qmi_response_type_v01 resp;
  /**<   Standard response type. */
}nas_set_high_capability_sub_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves high capability subscription. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}nas_get_high_capability_sub_req_msg_v01;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Retrieves high capability subscription. */
typedef struct {
  ...
  /*  High Capability Sub */
  nas_subs_type_enum_v01 high_capability_sub;
}nas_get_high_capability_sub_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Informs the control point of high capability
             subscription change. */
typedef struct {
  ...
  /*  High Capability Sub */
  nas_subs_type_enum_v01 high_capability_sub;
}nas_high_capability_sub_ind_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<
    Cell ID.
	Cell_id_valid will be invalid for NR5G. Get NR5G Cell ID from TLV "NR5G Cell ID".
  */
 ...
 */
  ...
  /* Optional */
  /*  NR5G Cell ID  */
  uint8_t nr5g_cell_id_valid;  /**< Must be set to true if nr5g_cell_id is being passed */
  uint64_t nr5g_cell_id;
  /**<   Indicates NR5G SA Cell ID. Values:\n
       The TLV is only applicable to NR5G SA mode.
  */
...
typedef struct {
  ...
  */
  ...
  /**<
     RSRQ value in dB (signed integer value) as measured by L1.
     Range for RSRQ values: -43 to 20 dB.
	 Invalid value (-32768) indicates that modem is not in EN-DC connected mode.
 */
 ...
 */
  ...
  /**<   Array of SNR thresholds (in units of 0.1 dB); maximum of 32 values.
      Range for SNR values: -230 to 400 (e.g., -230 means -23.0 dB).
 */
 ...
 */
  ...
  /**<   Array of RSRP thresholds (in units of 0.1 dBm); maximum of 32 values.
      Range for RSRP values: -1400 to -440 (e.g., -1400 means -140.0 dBm).
 */
 ...
 */
  ...
  /**<   Array of RSRQ thresholds (in units of 0.1 dB); maximum of 32 values.
      Range for RSRQ values: -430 to 200 (e.g., -430 means -43.0 dB).
 */
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  MDT enable  */
  uint8_t mdt_enable_valid;  /**< Must be set to true if mdt_enable is being passed */
  uint8_t mdt_enable;
  ...
  */
  ...
  /* Optional */
  /*  GNSS enable */
  uint8_t gnss_enable_valid;  /**< Must be set to true if gnss_enable is being passed */
  uint8_t gnss_enable;
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  NR5G RRC State */
  uint8_t nr5g_rrc_state_valid;  /**< Must be set to true if nr5g_rrc_state is being passed */
  nr5g_rrc_state_ext_e_type_v01 nr5g_rrc_state;
  /**<   NR5G RRC State. Values: \n
      - NR5G_RRC_STATE_IDLE_CAMPED (0) --  Idle Camped \n
      - NR5G_RRC_STATE_CONNECTED (1) --  Connected \n
      - NR5G_RRC_STATE_INACTIVE_CAMPED (2) --  Inactive Camped
 This TLV will not be populated when NR5G is not active.
 */

  /* Optional */
  /*  NR5G Serving Cell Frequency List */
  uint8_t nr5g_scell_arfcn_valid;  /**< Must be set to true if nr5g_scell_arfcn is being passed */
  uint32_t nr5g_scell_arfcn_len;  /**< Must be set to # of elements in nr5g_scell_arfcn */
  uint32_t nr5g_scell_arfcn[NAS_MAX_NR5G_SERVING_CELL_V01];
  /**<   NR5G Serving Cell Frequency List. */

  /* Optional */
  /*  NR5G Neighbor Frequency List */
  uint8_t nr5g_nbr_arfcn_valid;  /**< Must be set to true if nr5g_nbr_arfcn is being passed */
  uint32_t nr5g_nbr_arfcn_len;  /**< Must be set to # of elements in nr5g_nbr_arfcn */
  uint32_t nr5g_nbr_arfcn[NAS_MAX_NR5G_NBR_ARFCN_LIST_V01];
  /**<   NR5G Neighbor Frequency List. */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Indicates the DRX parameters configured by NR5G network. */
typedef struct {
  ...
  /**<   Radio interface technology of the signal being measured. Values: \n
       ...
       -0x08 -- RADIO_IF_LTE         -- LTE \n
       -0x0C -- RADIO_IF_NR5G        -- NR5G \n
      <Not all RATs are supported and an error will be returned for an invalid RAT.>\n
  */

  /* Optional */
  uint8_t ciot_lte_op_mode_valid;  /**< Must be set to true if ciot_lte_op_mode is being passed */
  nas_camped_ciot_lte_op_mode_enum_type_v01 ciot_lte_op_mode;
  /**<   Bitmask representing the Cellular Internet of Things (CIoT) LTE operational mode.
       If this TLV is sent with a RAT other than LTE the value will be ignored. Values: \n

   -- 0x02 -- NAS_CIOT_SYS_MODE_LTE_M1_V01\n
   -- 0x03 -- NAS_CIOT_SYS_MODE_LTE_NB1_V01\n */
}nas_jamming_status_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; Indicates the DRX parameters configured by NR5G network. */
typedef struct {
  ...
  */
  ...
  uint32_t jammer_status;
  /**<   jammer_status
       Values: \n
       - 0x00 -- Jammer Status Unknown \n
       - 0x01 -- Jammer status found\n
       - 0x02 -- Jammer status not found (Applicable only for NB1)\n  */

  /* Optional */
  /*  SOFT_JAMMER_FLAG */
  uint8_t soft_jammer_flag_valid;  /**< Must be set to true if soft_jammer_flag is being passed */
  uint8_t soft_jammer_flag;
}nas_jamming_status_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   jammer_status
       Values: \n
       - 0x00 -- Jammer Status not found \n
       - 0x01 -- Jammer status found\n
       - 0x02 -- Jammer status Unknown (Applicable only for NB1)\n  */

  /* Optional */
  /*  SOFT_JAMMER_FLAG */
  uint8_t soft_jammer_flag_valid;  /**< Must be set to true if soft_jammer_flag is being passed */
  uint8_t soft_jammer_flag;
}nas_jamming_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_NAS_GET_HIGH_CAPABILITY_SUB_V01
...
//#define REMOVE_QMI_NAS_HIGH_CAPABILITY_SUB_IND_V01
...
//#define REMOVE_QMI_NAS_SET_HIGH_CAPABILITY_SUB_V01
...
#define QMI_NAS_GET_HIGH_CAPABILITY_SUB_REQ_MSG_V01 0x00F2
#define QMI_NAS_GET_HIGH_CAPABILITY_SUB_RESP_MSG_V01 0x00F2
#define QMI_NAS_SET_HIGH_CAPABILITY_SUB_REQ_MSG_V01 0x00F3
#define QMI_NAS_SET_HIGH_CAPABILITY_SUB_RESP_MSG_V01 0x00F3
#define QMI_NAS_HIGH_CAPABILITY_SUB_IND_MSG_V01 0x00F4
#define QMI_NAS_JAMMING_STATUS_REQ_MSG_V01 0x00F5
#define QMI_NAS_JAMMING_STATUS_RESP_MSG_V01 0x00F5
#define QMI_NAS_JAMMING_STATUS_IND_MSG_V01 0x00F5
/**
    @}
  */
