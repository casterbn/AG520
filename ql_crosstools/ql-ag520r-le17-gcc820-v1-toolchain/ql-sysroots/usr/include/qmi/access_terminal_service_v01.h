...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2006-2017, 2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
/* This file was generated with Tool version 6.14.7
   It was generated on: Thu Sep 20 2018 (Spin 0)
...
#define AT_V01_IDL_MINOR_VERS 0x06
...
#define QMI_AT_CMD_RESP_LEN_MAX_V01 1000
#define QMI_AT_NUM_TOKEN_MAX_EX_V01 1500
/**
    @}
  */
...
typedef struct {
  ...
  /**<   AT command name
  */
}at_dereg_at_cmd_type_v01;  /* Type */
/**
    @}
  */

typedef uint32_t at_opcode_mask_v01;
#define QMI_AT_MASK_NA_V01 ((at_opcode_mask_v01)0x01) /**<  Denotes presence of the name field  */
#define QMI_AT_MASK_EQ_V01 ((at_opcode_mask_v01)0x02) /**<  Denotes presence of the equal (=) operator  */
#define QMI_AT_MASK_QU_V01 ((at_opcode_mask_v01)0x04) /**<  Denotes presence of the question mark (?)  */
#define QMI_AT_MASK_AR_V01 ((at_opcode_mask_v01)0x08) /**<  Denotes presence of the trailing argument operator  */
/** @addtogroup at_qmi_aggregates
    @{
  */
typedef struct {
...
typedef struct {
  ...
  /**<   AT URC type:
       - 0: URC_START --
         The URC buffer contains the start of a URC. More messages for the
         same URC could follow.
       - 1: URC_END --
         The URC buffer contains the end of a URC. No more URC messages follow.
       - 2: URC_INTERMEDIATE --
         The URC buffer contains an intermediate part of a URC.
       - 3: URC_COMPLETE --
         The URC buffer contains a complete URC. No other URC messages for
...
typedef struct {
  ...
  */
  ...
  /**<   Result of the AT command.
  */

  uint8_t response_type;
  /**<   AT command response type:
    - 0: RESPONSE_START --
      A partial response is present in the response buffer and this is
      the first buffer of the response. More response buffers will follow.
    - 1: RESPONSE_END --
      The response buffer completes the response for the AT command sent.
      There are partial response buffers.
    - 2: RESPONSE_INTERMEDIATE --
      Intermediate response buffer. More response buffers will follow.
    - 3: RESPONSE_COMPLETE --
      The response buffer contains a complete response and it must not contain an
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Request Message; Used by the control point to register any AT commands that are to
    be forwarded to the control point from the modem.
    (Deprecated) */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Response Message; Used by the control point to register any AT commands that are to
    be forwarded to the control point from the modem.
    (Deprecated) */
typedef struct {
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Indication Message; Forwards an AT command to the control point. (Deprecated) */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Request Message; Sends the response to an AT command that was previously forwarded
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Response Message; Sends the response to an AT command that was previously forwarded
    to the control point from the modem. */
typedef struct {
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Indication Message; Notifies the control point that a particular AT command that was
    forwarded earlier has been aborted. */
typedef struct {
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Request Message; Used by the control point to send the Unsolicited Result Code (URC)
    to the modem. */
typedef struct {
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Response Message; Used by the control point to send the Unsolicited Result Code (URC)
    to the modem. */
typedef struct {
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Indication Message; Internal dummy indication message; not used by external clients.
    (Deprecated) */
typedef struct {
  ...
  /**<   Dummy buffer. Used only to define a large buffer for the IDL.
    */
...
typedef struct {
  ...
  /* Optional */
  /*  Support Extended Tokens */
  uint8_t support_token_ex_valid;  /**< Must be set to true if support_token_ex is being passed */
  uint8_t support_token_ex;
  /**<   Support extended tokens for large data: \n
       - 1 -- Request to support extended token data
  */
...
typedef struct {
  ...
  uint8_t token_ex_support_valid;  /**< Must be set to true if token_ex_support is being passed */
  uint8_t token_ex_support;
  /**<   Indicates whether modem supports extended tokens or not. \n
       - 0 -- Not supported \n
       - 1 -- Supported
  */
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Indication Message; Forwards an AT command to the control point. */
typedef struct {
  ...
  */
  ...
  uint8_t token_ex_valid;  /**< Must be set to true if token_ex is being passed */
  uint32_t token_ex_len;  /**< Must be set to # of elements in token_ex */
  uint8_t token_ex[QMI_AT_NUM_TOKEN_MAX_EX_V01];
  /**<   List of extended tokens.
    */
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Request Message; Used by the control point to de-register AT commands that are
    already registered for forwarding from modem using
    QMI_AT_REG_AT_CMD_FWD_EX_REQ message */
typedef struct {

  /* Mandatory */
  /*  AT Commands to deregister */
  uint32_t at_cmd_list_len;  /**< Must be set to # of elements in at_cmd_list */
  at_dereg_at_cmd_type_v01 at_cmd_list[QMI_AT_NUM_CMD_MAX_V01];
}at_dereg_at_cmd_fwd_ex_req_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup at_qmi_messages
    @{
  */
/** Response Message; Used by the control point to de-register AT commands that are
    already registered for forwarding from modem using
    QMI_AT_REG_AT_CMD_FWD_EX_REQ message */
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}at_dereg_at_cmd_fwd_ex_resp_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_AT_DEREG_AT_CMD_FWD_EX_V01
...
#define QMI_AT_DEREG_AT_CMD_FWD_EX_REQ_V01 0x0027
#define QMI_AT_DEREG_AT_CMD_FWD_EX_RESP_V01 0x0027
