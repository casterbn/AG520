...
/* This file was generated with Tool version 6.14.7
   It was generated on: Wed Jun 19 2019 (Spin 0)
...
#define QOS_V01_IDL_MINOR_VERS 0x0F
...
typedef struct {
  ...
  /**<   5G TX QoS Class Identifier (QCI). Valid if flow_valid_params of
       tx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. The
  ...
  /**<   5G RX QoS Class Identifier (QCI) Valid if flow_valid_params of
       rx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. The
       elements of this list correspond to the list elements of
       Rx QoS Flow TLV.*/
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated. Valid if flow_valid_params
       of tx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.The
       elements of this list correspond to the list elements of
       Tx QoS Flow TLV.
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       rx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The
       elements of this list correspond to the list elements of
       Rx QoS Flow TLV.
     */
 ...
 */
  ...
  */
  ...
  /**<   5G TX QoS Class Identifier (QCI). Valid if flow_valid_params of
       tx_qos_flow_granted TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. */
  ...
  /**<   5G RX QoS Class Identifier (QCI). Valid if flow_valid_params of
       rx_qos_flow_granted TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set. */
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       tx_qos_flow_granted TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.
   */
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       rx_qos_flow_granted TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.
    */
...
typedef struct {
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       tx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set. The
       elements of this list correspond to the list elements of
       Tx QoS Flow TLV.
   */
 ...
 */
  ...
  */
  ...
  qos_flow_5g_qci_enum_v01 tx_5g_qci;
  /**<   5G TX QoS Class Identifier (QCI. Valid if flow_valid_params of
       tx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set). */
  ...
  qos_flow_5g_qci_enum_v01 rx_5g_qci;
  /**<   5G RX QoS Class Identifier (QCI). Valid if flow_valid_params of
       rx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_5G_QCI bit set).  */
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       tx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.
   */
  ...
  /**<   Represents the duration in ms over which the GFBR (Guaranteed Flow Bit rate) and
       MFBR (Max Flow Bit Rate) shall be calculated.Valid if flow_valid_params of
       rx_qos_flow TLV has QMI_QOS_IP_FLOW_MASK_AVG_WINDOW bit set.
    */
