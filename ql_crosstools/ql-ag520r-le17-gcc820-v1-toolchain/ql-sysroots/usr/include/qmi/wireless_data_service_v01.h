...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/wds/api/wireless_data_service_v01.h#56 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define WDS_V01_IDL_MINOR_VERS 0xAF
...
typedef enum {
  ...
  WDS_CAPABILITY_PDN_THROTTLE_V2_V01 = 0x02, /**<  Support PDN throttle information verson 2  */
...
typedef enum {
  ...
  WDS_CAPABILITY_ROAMING_INFO_V2_V01 = 0x02, /**<  Support roaming information verson 2  */
...
typedef struct {
  ...
  uint8_t send_scri;
  /**<   Send SCRI(Signaling Connection Release Indicator) if
       0 : Send SCRI with/without REL8-FD
       1 : Send SCRI if current cell supports REL8-FD otherwise discard the request
   */
 ...
 */
  ...
  /**<  \n Capability for PDN throttle informtation. Values: \n
      - WDS_CAPABILITY_PDN_THROTTLE_V1 (0x01) --  Default. Support PDN throttle information version 1
      - WDS_CAPABILITY_PDN_THROTTLE_V2 (0x02) --  Support PDN throttle information verson 2
 */
  ...
  /**<  \n Capability for roaming informtation. Values: \n
      ...
      - WDS_CAPABILITY_ROAMING_INFO_V2 (0x02) --  Support roaming information verson 2
 */
...
typedef struct {
  ...
  /**<   \n Specifies the TCP/UDP coalescing setting to be configured on the modem for
       the bound MUX ID.
  */
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Sets LADN configuration in modem */
typedef struct {
  ...
  /**<   PLMN ID. A PLMN ID is stored in three octets, as specified in 3G TS 24.008, Section 10.5.1.3.
                                        Bit
                 |  8  |  7  |  6  |  5  |  4  |  3  |  2  |  1  |
                 |===============================================|
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Sets LADN configuration in modem */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the LADN information on modem. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Gets LADN information in modem */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Gets LADN information in modem */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Request Message; Negotiate various capabilities between TE and modem. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Response Message; Negotiate various capabilities between TE and modem. */
typedef struct {
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the PDN Throttle information (version2) to the control point
...
/** @addtogroup wds_qmi_messages
    @{
  */
/** Indication Message; Indicates the Roaming information (version2) to the control point
           that sent QMI_WDS_GET_ROAMING_INFO request */
typedef struct {
