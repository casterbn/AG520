...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Jan 27 2020 (Spin 0)
...
#define DPM_V01_IDL_MINOR_VERS 0x07
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DPM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define DPM_V01_MAX_MESSAGE_ID 0x0023
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  Report Port Status */
  uint8_t report_port_status_valid;  /**< Must be set to true if report_port_status is being passed */
  uint8_t report_port_status;
  /**<   Values: \n
      - 0 -- Do not report \n
      - 1 -- Report DPM port status 
  */

  /* Optional */
  /*  Hardware Data Port List */
  uint8_t hardware_port_list_valid;  /**< Must be set to true if hardware_port_list is being passed */
  uint32_t hardware_port_list_len;  /**< Must be set to # of elements in hardware_port_list */
  data_ep_id_type_v01 hardware_port_list[QMI_DPM_PORT_MAX_NUM_V01];
  /**<   \n 
      (Provides the configuration details specific to a hardware-accelerated port.)
  ...
  */
  ...
  ctl_port_map_details_v01 control_port_list[QMI_DPM_PORT_MAX_NUM_V01];
  /**<   \n
     (Provides the configuration details specific to a Control Port.)
   */
}dpm_indication_register_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  qmi_response_type_v01 resp;
  /**<   Standard response type.*/
}dpm_indication_register_resp_msg_v01;  /* Message */
/**
    @}
  */

/** @addtogroup dpm_qmi_enums
    @{
  */
typedef enum {
  DPM_PORT_STATE_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  DPM_PORT_STATE_NONE_V01 = 0, /**<  Port state is Unknown\n  */
  DPM_PORT_STATE_OPEN_SUCCESS_V01 = 1, /**<  Port is open successfully */
  DPM_PORT_STATE_CLOSE_SUCCESS_V01 = 2, /**<  Port is closed successfully */
  DPM_PORT_STATE_OPEN_FAILURE_V01 = 3, /**<  Port Open is failed  */
  DPM_PORT_STATE_CLOSE_FAILURE_V01 = 4, /**<  Port close operatiom failure */
  DPM_PORT_STATE_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}dpm_port_state_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  dpm_port_state_enum_v01 port_state;
  /**<   State of the data port.
  */

  data_ep_id_type_v01 hardware_port;
  /**<   Peripheral endpoint of the data port.
  */
}data_port_status_type_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  ctl_port_map_details_v01 control_port;
  /**<   Peripheral control endpoint of the control port.
  */
}ctl_port_status_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup dpm_qmi_messages
    @{
  */
/** Indication Message; Indicates the port status of the specified Data ports. */
typedef struct {

  /* Optional */
  /*  Data Port Status */
  uint8_t data_port_status_valid;  /**< Must be set to true if data_port_status is being passed */
  uint32_t data_port_status_len;  /**< Must be set to # of elements in data_port_status */
  data_port_status_type_v01 data_port_status[QMI_DPM_PORT_MAX_NUM_V01];
  /**<  \n
  */
  ...
  uint8_t control_port_list_valid;  /**< Must be set to true if control_port_list is being passed */
  uint32_t control_port_list_len;  /**< Must be set to # of elements in control_port_list */
  ctl_port_status_type_v01 control_port_list[QMI_DPM_PORT_MAX_NUM_V01];
  /**<  \n
  */
}dpm_port_status_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_DPM_INDICATION_REGISTER_V01 
//#define REMOVE_QMI_DPM_OPEN_PORT_V01 
//#define REMOVE_QMI_DPM_PORT_STATUS_IND_V01 

/*Service Message Definition*/
/** @addtogroup dpm_qmi_msg_ids
    @{
  */
#define QMI_DPM_INDICATION_REGISTER_REQ_V01 0x0001
#define QMI_DPM_INDICATION_REGISTER_RESP_V01 0x0001
...
#define QMI_DPM_PORT_STATUS_IND_V01 0x0023
/**
    @}
  */
