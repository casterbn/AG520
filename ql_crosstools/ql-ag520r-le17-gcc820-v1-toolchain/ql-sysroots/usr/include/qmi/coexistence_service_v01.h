...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/qmimsgs/coex/api/coexistence_service_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Mon Sep 30 2019 (Spin 0)
...
#define COEX_V01_IDL_MINOR_VERS 0x1F
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define COEX_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define COEX_V01_MAX_MESSAGE_ID 0x004C
/**
    @}
  */
...
#define COEX_ANT_BLOCKING_MAX_ANTS_V01 16
#define COEX_ANT_BLOCKING_MAX_BANDS_V01 8
/**
    @}
  */
...
typedef struct {
  ...
  uint8_t ant_num;
  /**<   Identifies which Antenna ID the information refers to. The bands
       represented by band_numbers below should be blocked/unblocked
       on this particular antenna.
  */

  uint32_t band_number_len;  /**< Must be set to # of elements in band_number */
  int32_t band_number[COEX_ANT_BLOCKING_MAX_BANDS_V01];
  /**<   Band numbers from MMCP band enum on which the antenna should
       be blocked/unblocked.
  */
}coex_ant_blocking_info_type_v01;  /* Type */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Request Message; Enables or disables Antenna blocking on particular antennae */
typedef struct {

  /* Optional */
  /*  Antenna Blocking Information  */
  uint8_t ant_blocking_info_valid;  /**< Must be set to true if ant_blocking_info is being passed */
  uint32_t ant_blocking_info_len;  /**< Must be set to # of elements in ant_blocking_info */
  coex_ant_blocking_info_type_v01 ant_blocking_info[COEX_ANT_BLOCKING_MAX_ANTS_V01];
  /**<   Antenna to band number maps for the antennae on which antenna blocking
       should be supported.
  */
}coex_set_ant_blocking_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup coex_qmi_messages
    @{
  */
/** Response Message; Enables or disables Antenna blocking on particular antennae */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members:
     ...
     - qmi_error_type  -- Error code. Possible error code values are described
                          in the error codes section of each message definition.
  */
}coex_set_ant_blocking_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_COEX_SET_ANT_BLOCKING_V01
...
#define QMI_COEX_SET_ANT_BLOCKING_REQ_V01 0x004C
#define QMI_COEX_SET_ANT_BLOCKING_RESP_V01 0x004C
/**
    @}
  */
