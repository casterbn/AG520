...
/******************************************************************************
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2007-2010, 2013-2014, 2018-2019 Qualcomm Technologies, Inc.
  All Rights Reserved.
...
#elif defined(FEATURE_DATA_LOG_ADB) /* !FEATURE_QMI_ANDROID */
...
#else /* !FEATURE_QMI_ANDROID && !FEATURE_DATA_LOG_ADB */
...
#if defined (FEATURE_DATA_LOG_STDERR)
...
#elif defined (FEATURE_QMI_TEST) /* !FEATURE_DATA_LOG_STDERR */
#include "tf_log.h"
...
/* FEATURE_DATA_LOG_STDERR && !FEATURE_QMI_TEST */
...
/* FEATURE_DATA_LOG_STDERR && !FEATURE_QMI_TEST &&
   !(FEATURE_EXTERNAL_AP && !FEATURE_DATA_LOG_QXDM) */
...
/* FEATURE_DATA_LOG_STDERR && !FEATURE_QMI_TEST &&
   !(FEATURE_EXTERNAL_AP && !FEATURE_DATA_LOG_QXDM)
   && !FEATURE_DATA_LOG_FILE && !FEATURE_DATA_LOG_ADB */
