...
#define DMS_V01_IDL_MINOR_VERS 0x43
...
typedef enum {
  ...
  DMS_SENSOR_TYPE_ALS_V01 = 1, /**<     For Sensor information about                   Ambient Light Sensor\n   */
  DMS_SENSOR_TYPE_PRESSURE_V01 = 2, /**<  For Sensor information about pressure\n   */
  DMS_SENSOR_TYPE_HUMIDITY_V01 = 3, /**<  For Sensor information about humidity\n   */
  DMS_SENSOR_TYPE_TEMPERATURE_V01 = 4, /**<  For Sensor information about temperature\n   */
  DMS_SENSOR_TYPE_AMD_V01 = 5, /**<  For Sensor information about Motion\n   */
  DMS_SENSOR_TYPE_SMD_V01 = 6, /**<  For Sensor information about Motion\n   */
...
#define DMS_MASK_SENSOR_ID_ALS_V01 ((dms_sensor_id_mask_v01)0x0001)
#define DMS_MASK_SENSOR_ID_PRESSURE_V01 ((dms_sensor_id_mask_v01)0x0002)
#define DMS_MASK_SENSOR_ID_HUMIDITY_V01 ((dms_sensor_id_mask_v01)0x0004)
#define DMS_MASK_SENSOR_ID_TEMPERATURE_V01 ((dms_sensor_id_mask_v01)0x0008)
#define DMS_MASK_SENSOR_ID_AMD_V01 ((dms_sensor_id_mask_v01)0x0010)
#define DMS_MASK_SENSOR_ID_SMD_V01 ((dms_sensor_id_mask_v01)0x0020)
/** @addtogroup dms_qmi_aggregates
    @{
  */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   Values: \n
  - 0 -- Do not report \n
  - 1 -- Report power configuration requests from modem
  */
  ...
  /**<   Values: \n
    - 0 -- Do not report \n
    - 1 -- Report device interactive state requests from modem
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Sends the sensor configuration parameters to modem. */
typedef struct {
  ...
  /* Optional */
  /*  Sensor type for which the configuration is sent
  ...
  /* Optional */
  /*  Number of sample collections after which modem needs to report to control point
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Sends the sensor configuration parameters to modem. */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Query sensor data snapshot from modem */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Query sensor data snapshot from modem */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/**  Message; Notifies control point whenever the sensor policy is met or if batch is full */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Indication Message; Indicates the request from modem to report the device
            power information */
typedef struct {
  ...
  */
  ...
  /**<   List of threshold values ranging from 0 to 100 in % that
       triggers battery reporting. Only applicable when Report Power Status
       TLV is set to TRUE.
  */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies modem about the power information on UE.  */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies modem about the power information on UE.  */
typedef struct {
...
typedef enum {
  ...
  DMS_INTERACTIVE_STATE_INVALID_V01 = 0,
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Notifies modem about the device interactive state.  */
typedef struct {
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Notifies modem about the device interactive state.  */
typedef struct {
