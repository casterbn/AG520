...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Fri Jun 21 2019 (Spin 0)
...
/**  Maximum length of an MO PDU  */
#define MCM_SMS_MAX_MO_PDU_LENGTH_V01 255
...
/** @addtogroup mcm_sms_qmi_enums
  ...
  */
typedef enum {
  MCM_SMS_PDU_FORMAT_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_SMS_PDU_FORMAT_CDMA_V01 = 0x00, 
  MCM_SMS_PDU_FORMAT_GW_PP_V01 = 0x06, 
  MCM_SMS_PDU_FORMAT_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_sms_pdu_format_t_v01;
/**
    @}
  */
...
/** @addtogroup mcm_sms_qmi_messages
    @{
  */
/** Request Message; Sends an MO PDU. */
typedef struct {

  /* Mandatory */
  mcm_sms_pdu_format_t_v01 pdu_format;
  /**<   Message format. */

  /* Mandatory */
  uint32_t pdu_content_len;  /**< Must be set to # of elements in pdu_content */
  char pdu_content[MCM_SMS_MAX_MO_PDU_LENGTH_V01];
  /**<   Message content. */
}mcm_sms_send_mo_pdu_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup mcm_sms_qmi_messages
    @{
  */
/** Response Message; Sends an MO PDU. */
typedef struct {

  /* Mandatory */
  mcm_response_t_v01 response;
  /**<   Result code.*/
}mcm_sms_send_mo_pdu_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup mcm_sms_qmi_messages
    @{
  */
/** Request Message; Point-to-point pdu indication. */
typedef struct {
  ...
  uint32_t pdu_content_len;  /**< Must be set to # of elements in pdu_content */
  char pdu_content[MCM_SMS_MAX_MO_PDU_LENGTH_V01];
}mcm_sms_pp_pdu_ind_msg_v01;  /* Message */
/**
    @}
  */
...
#define MCM_SMS_SEND_MO_PDU_REQ_V01                     0x0707
#define MCM_SMS_SEND_MO_PDU_RESP_V01                    0x0707
#define MCM_SMS_PP_IND_V01                              0x0708
#define MCM_SMS_CB_IND_V01                              0x0709
#define MCM_SMS_CB_CMAS_IND_V01                         0x070A
#define MCM_SMS_STORAGE_IND_V01                         0x070B
#define MCM_SMS_PP_PDU_IND_V01                          0x070C
