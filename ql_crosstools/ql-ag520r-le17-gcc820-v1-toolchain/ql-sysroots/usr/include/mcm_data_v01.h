...
/**  Maxinum number of modem apn list */
#define MCM_DATA_MODEM_APN_LIST_MAX_V01 32
/**
    @}
  */
...
/** @addtogroup mcm_data_qmi_enums
    @{
  */
typedef enum {
  MCM_DATA_CALL_AUTH_PREF_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_DATA_AUTH_PREF_PAP_CHAP_NOT_ALLOWED_V01 = 0, 
  MCM_DATA_AUTH_PREF_PAP_ONLY_ALLOWED_V01 = 1, 
  MCM_DATA_AUTH_PREF_CHAP_ONLY_ALLOWED_V01 = 2, 
  MCM_DATA_AUTH_PREF_PAP_CHAP_BOTH_ALLOWED_V01 = 3, 
  MCM_DATA_CALL_AUTH_PREF_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_data_call_auth_pref_t_v01;
/**
    @}
  */

/** @addtogroup mcm_data_qmi_aggregates
    @{
  */
typedef struct {
...
/** @addtogroup mcm_data_messages
  ...
  */
typedef enum {
  MCM_DATA_WDS_PDP_TYPE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_DATA_WDS_PDP_TYPE_IPV4_V01 = 0x00, /**<   IPv4 \n   */
  MCM_DATA_WDS_PDP_TYPE_PPP_V01 = 0x01, /**<   PPP \n   */
  MCM_DATA_WDS_PDP_TYPE_IPV6_V01 = 0x02, /**<   IPv6 \n   */
  MCM_DATA_WDS_PDP_TYPE_IPV4V6_V01 = 0x03, /**<   IPv4 and IPv6    */
  MCM_DATA_WDS_PDP_TYPE_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_data_wds_pdp_type_t_v01;
/**
    @}
  */
...
typedef struct {
  ...
  mcm_data_wds_pdp_type_t_v01 pdp_type;
}mcm_data_modem_apn_info_v01;  /* Type */
/**
    @}
  */

/** @addtogroup mcm_data_qmi_messages
    @{
  */
/**  Message;  */
typedef struct {
  ...
  char __placeholder;
}mcm_data_get_modem_apn_list_req_msg_v01;
...
typedef struct {
  ...
  mcm_data_modem_apn_info_v01 apn_list[MCM_DATA_MODEM_APN_LIST_MAX_V01];
}mcm_data_get_modem_apn_list_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  mcm_data_wds_pdp_type_t_v01 pdp_type;
}mcm_data_set_modem_apn_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  mcm_response_t_v01 resp;
  /**<   Result code.*/
}mcm_data_set_modem_apn_info_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  uint8_t pdp_type_valid;  /**< Must be set to true if pdp_type is being passed */
  mcm_data_wds_pdp_type_t_v01 pdp_type;
}mcm_data_add_modem_apn_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  mcm_response_t_v01 resp;
  /**<   Result code.*/
}mcm_data_add_modem_apn_info_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t profile_index;
}mcm_data_del_modem_apn_info_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  mcm_response_t_v01 resp;
  /**<   Result code.*/
}mcm_data_del_modem_apn_info_rsp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  uint8_t auth_pref_valid;  /**< Must be set to true if auth_pref is being passed */
  mcm_data_call_auth_pref_t_v01 auth_pref;
...
#define MCM_DATA_GET_MODEM_APN_LIST_REQ_MSG_V01 0x010D
#define MCM_DATA_GET_MODEM_APN_LIST_RSP_MSG_V01 0x010D
#define MCM_DATA_SET_MODEM_APN_INFO_REQ_MSG_V01 0x010E
#define MCM_DATA_SET_MODEM_APN_INFO_RSP_MSG_V01 0x010E
#define MCM_DATA_ADD_MODEM_APN_INFO_REQ_MSG_V01 0x010F
#define MCM_DATA_ADD_MODEM_APN_INFO_RSP_MSG_V01 0x010F
#define MCM_DATA_DEL_MODEM_APN_INFO_REQ_MSG_V01 0x0110
#define MCM_DATA_DEL_MODEM_APN_INFO_RSP_MSG_V01 0x0110
/**
    @}
  */
